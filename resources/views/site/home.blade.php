                    ...
                    <div class="d-flex flex-wrap col-lg-12 text-design">
                        ...
                        <div class="col-lg-4">
                            <div class="card" style="width: 18rem;">
                                <a href="{{ route('blogs.details',$blog->slug) }}" class="text-decoration-none">
                                    <img class="card-img-top" src="{{ $blog->getFirstMediaUrl('blog-image') }}" alt="Card image cap" >
                                    <div class="card-body">
                                        <h5 class="card-title">{{ $blog->title }}</h5>
                                        <p class="card-text text-dark">{!! $blog->sort_description !!}</p>
                                    </div>
                                </a>
                            </div>
                        </div>
            ...
            <div class="container mt-5">
                <div class="row">
                    <div id="cardCarousel" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <!-- Controls -->
                        @if($certificate_is_schorallable)
                    ...
                    <div class="col-lg-4">
                        <div class="card text-start">
                            <div class="card-body">
                                ...
                                <a href="{{ route('registration') }}" class="btn bsb-btn-2xl btn-outline-light">Get Certified</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row align-items-center header-banner" style="padding: 0rem 4rem;">
                    ...
                    <div class="col-12 col-md-6 text-start">
                        ...
                        <a href="{{ route('contact') }}" class="btn bsb-btn-2xl btn-outline-light">Free Consultation</a>
                    </div>
                    <div class="col-12 col-md-6 text-start">
